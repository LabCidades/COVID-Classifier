    ...
    \begin{columns}
        ...
        \begin{column}{0.7\textwidth}
            \begin{vfilleditems}
                ...
                \item alta sensibilidade de estimativas
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{vfilleditems}
                ...
                \item tempo médio em dias em que os indivíduos estão infectantes $dI$ e em estado terminal $dT$
            \end{vfilleditems}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{align*}
...
\begin{frame}{Incorporação de Sintomas de Redes Sociais no Modelo}
    ...
    \begin{align*}
        ...
        \textcolor{red}{\text{Tweets}} &\sim \text{Binomial Negativa}\left(\text{compartimento $I$} \cdot \text{Prop. Tweets}, \frac{1}{\phi_{\text{tweets}}}\right)
    \end{align*}
    Podemos também partir do pressuposto que uma pessoa tuíta apenas uma vez por dia seu sintoma e colocar uma \textit{priori} em Prop. Tweets como uma $\text{Beta}(1, 1)$
\end{frame}
...
\begin{frame}{Aprendizagem de Máquina}
    ...
    \begin{vfilleditems}
        \item Precisão: $\frac{\text{Verdadeiro Positivos}}{\text{Verdadeiro Positivos} + \text{Falso Positivos}}$
...
\begin{frame}{Próximos Passos - Modelo Epidemiológico Bayesiano}
    \begin{vfilleditems}
        ...
        \item tempo médio em dias em que os indivíduos estão em estado terminal variável $\boldsymbol{dT}$
